...
public class SpanBuilder {
     ...
     *             </ul>
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setBullet(@ColorInt final int color,
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFontProportion(final float proportion) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFontXProportion(final float proportion) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setHorizontalAlign(@NonNull final Layout.Alignment alignment) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpanBuilder} instance
     */
    public SpanBuilder appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
